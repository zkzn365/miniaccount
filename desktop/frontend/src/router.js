...
const routes = [
  ...
  { path: '/assets', name: 'assets', component: () => import('./views/Assets.vue'), meta: { title: '固定资产', icon: 'Building2' } },
  { path: '/workpaper', name: 'workpaper', component: () => import('./views/Workpaper.vue'), meta: { title: '审计底稿', icon: 'ClipboardCheck' } },
  { path: '/vat', name: 'vat', component: () => import('./views/VAT.vue'), meta: { title: '增值税', icon: 'Percent' } },
  { path: '/taxreturn', name: 'taxreturn', component: () => import('./views/TaxReturn.vue'), meta: { title: '税务计算表', icon: 'ReceiptText' } },
  { path: '/auditdoc', name: 'auditdoc', component: () => import('./views/AuditDoc.vue'), meta: { title: '审计文书', icon: 'FileSignature' } },
