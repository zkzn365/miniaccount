...
import {
  ...
  ScrollText, ListTree, Shapes, Building2, ClipboardCheck, ReceiptText, FileSignature,
...
const icons = {
  ...
  Sparkles, Settings: Cog, ScrollText, ListTree, Shapes, Building2, ClipboardCheck,
  ReceiptText, FileSignature,
}
