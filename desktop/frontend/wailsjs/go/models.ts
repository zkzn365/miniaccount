...
export namespace main {
	...
	export class AccrueRequest {
	    ...
	    static createFrom(source: any = {}) {
	        return new AccrueRequest(source);
	    }
	...
	export class AmortizationRequest {
	    ...
	    static createFrom(source: any = {}) {
	        return new AmortizationRequest(source);
	    }
	...
	export class AssetRequest {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.category = source["category"];
	        this.deptId = source["deptId"];
	        this.origYuan = source["origYuan"];
	        this.salvagePpm = source["salvagePpm"];
	        this.usefulMonths = source["usefulMonths"];
	        this.startDate = source["startDate"];
	        this.expenseAccount = source["expenseAccount"];
	        this.accumAccount = source["accumAccount"];
	        this.disposedDate = source["disposedDate"];
	        this.remark = source["remark"];
	    }
	}
	...
	export class VoidAmortizationRequest {
	    id: number;
	    void: boolean;
	
	    static createFrom(source: any = {}) {
	        return new VoidAmortizationRequest(source);
	    }
...
export namespace service {
	...
	export class AccrualRow {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.debitAccount = source["debitAccount"];
	        this.debitName = source["debitName"];
	        this.creditAccount = source["creditAccount"];
	        this.creditName = source["creditName"];
	        this.auxDesc = source["auxDesc"];
	        this.reason = source["reason"];
	    }
	}
	export class AccrualPreview {
	    period: string;
	    rows: AccrualRow[];
	    depreciationTotal: number;
	    amortizationTotal: number;
	    depreciationDone: boolean;
	    amortizationDone: boolean;
	    previousPeriod: string;
	    previousMissing: number;
	
	    static createFrom(source: any = {}) {
	        return new AccrualPreview(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.period = source["period"];
	        this.rows = this.convertValues(source["rows"], AccrualRow);
	        this.depreciationTotal = source["depreciationTotal"];
	        this.amortizationTotal = source["amortizationTotal"];
	        this.depreciationDone = source["depreciationDone"];
	        this.amortizationDone = source["amortizationDone"];
	        this.previousPeriod = source["previousPeriod"];
	        this.previousMissing = source["previousMissing"];
	    }
	...
	export class AccrualResult {
	    period: string;
	    depreciationVoucherId: number;
	    amortizationVoucherId: number;
	    depreciationTotal: number;
	    amortizationTotal: number;
	    skipped: string[];
	    ...
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.period = source["period"];
	        this.depreciationVoucherId = source["depreciationVoucherId"];
	        this.amortizationVoucherId = source["amortizationVoucherId"];
	        this.depreciationTotal = source["depreciationTotal"];
	        this.amortizationTotal = source["amortizationTotal"];
	...
	export class AmortizationView {
	    ...
	    static createFrom(source: any = {}) {
	        return new AmortizationView(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.amortized = source["amortized"];
	        this.remaining = source["remaining"];
	        this.firstPeriod = source["firstPeriod"];
	        this.lastPeriod = source["lastPeriod"];
	        this.canDelete = source["canDelete"];
	        this.reason = source["reason"];
	    }
	}
	export class AssetCategoryOption {
	    ...
	    static createFrom(source: any = {}) {
	        return new AssetCategoryOption(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.value = source["value"];
	        this.label = source["label"];
	        this.minYears = source["minYears"];
	        this.minMonths = source["minMonths"];
	    }
	}
	export class AssetDefaults {
	    ...
	    static createFrom(source: any = {}) {
	        return new AssetDefaults(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.depreciationExpense = source["depreciationExpense"];
	        this.accumDepreciation = source["accumDepreciation"];
	        this.assetAccount = source["assetAccount"];
	        this.amortExpense = source["amortExpense"];
	        this.amortAsset = source["amortAsset"];
	    }
	}
	export class AssetView {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.deptId = source["deptId"];
	        this.deptName = source["deptName"];
	        this.origValue = source["origValue"];
	        this.salvagePpm = source["salvagePpm"];
	        this.salvageRateLabel = source["salvageRateLabel"];
	        this.salvageValue = source["salvageValue"];
	        this.usefulMonths = source["usefulMonths"];
	        this.startDate = source["startDate"];
	        this.expenseAccount = source["expenseAccount"];
	        this.accumAccount = source["accumAccount"];
	        ...
	        this.remark = source["remark"];
	        this.monthlyAmount = source["monthlyAmount"];
	        this.depreciated = source["depreciated"];
	        this.netValue = source["netValue"];
	        this.firstPeriod = source["firstPeriod"];
	        this.lastPeriod = source["lastPeriod"];
	        this.minYears = source["minYears"];
	        this.lifeWarning = source["lifeWarning"];
	        this.canDelete = source["canDelete"];
	        this.reason = source["reason"];
	    }
	}
	export class AssetsView {
	    ...
	    static createFrom(source: any = {}) {
	        return new AssetsView(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.assets = this.convertValues(source["assets"], AssetView);
	        this.amortizations = this.convertValues(source["amortizations"], AmortizationView);
	        this.defaults = this.convertValues(source["defaults"], AssetDefaults);
	        this.categories = this.convertValues(source["categories"], AssetCategoryOption);
	    }
